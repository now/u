...
{
	BREAKTYPE2ID(UNICODE_WORD_BREAK_ALETTER, aletter);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_CR, cr);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_EXTEND, extend);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_EXTENDNUMLET, extendnumlet);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_FORMAT, format);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_KATAKANA, katakana);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_LF, lf);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_MIDLETTER, midletter);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_MIDNUM, midnum);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_MIDNUMLET, midnumlet);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_NEWLINE, newline);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_NUMERIC, numeric);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_OTHER, other);
	BREAKTYPE2ID(UNICODE_WORD_BREAK_REGIONAL_INDICATOR, regional_indicator);

        switch (type) {
	case UNICODE_WORD_BREAK_ALETTER:
		return ID2SYM(id_aletter);
	case UNICODE_WORD_BREAK_CR:
		return ID2SYM(id_cr);
	case UNICODE_WORD_BREAK_EXTEND:
		return ID2SYM(id_extend);
	case UNICODE_WORD_BREAK_EXTENDNUMLET:
	...
	case UNICODE_WORD_BREAK_LF:
		return ID2SYM(id_lf);
	case UNICODE_WORD_BREAK_MIDLETTER:
		return ID2SYM(id_midletter);
	case UNICODE_WORD_BREAK_MIDNUM:
		return ID2SYM(id_midnum);
	case UNICODE_WORD_BREAK_MIDNUMLET:
		return ID2SYM(id_midnumlet);
	case UNICODE_WORD_BREAK_NEWLINE:
		return ID2SYM(id_newline);
	case UNICODE_WORD_BREAK_NUMERIC:
		return ID2SYM(id_numeric);
	case UNICODE_WORD_BREAK_OTHER:
		return ID2SYM(id_other);
	case UNICODE_WORD_BREAK_REGIONAL_INDICATOR:
