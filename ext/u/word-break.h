extern const uint8_t (*_u_word_break_property_data)[256];
extern const int16_t *_u_word_break_property_table_part1;
extern const int16_t *_u_word_break_property_table_part2;
