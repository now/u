...
Init_u_string(VALUE mU)
{
        ...
        rb_define_method(rb_cUString, "bytes", rb_u_string_each_byte, 0); /* in ext/u/rb_u_string_each_byte.c */
        ...
        rb_define_method(rb_cUString, "chars", rb_u_string_each_char, 0); /* in ext/u/rb_u_string_each_char.c */
        ...
        rb_define_method(rb_cUString, "digits?", rb_u_string_digit, 0); /* in ext/u/rb_u_string_digit.c */
        ...
        rb_define_method(rb_cUString, "each", rb_u_string_each_line, -1); /* in ext/u/rb_u_string_each_line.c */
        ...
        rb_define_method(rb_cUString, "end_with?", rb_u_string_ends_with, -1); /* in ext/u/rb_u_string_ends_with.c */
        rb_define_method(rb_cUString, "ends_with?", rb_u_string_ends_with, -1); /* in ext/u/rb_u_string_ends_with.c */
        ...
        rb_define_method(rb_cUString, "intern", rb_u_string_to_sym, 0); /* in ext/u/rb_u_string_to_sym.c */
        rb_define_method(rb_cUString, "length", rb_u_string_length, 0); /* in ext/u/rb_u_string_length.c */
        rb_define_method(rb_cUString, "lines", rb_u_string_each_line, -1); /* in ext/u/rb_u_string_each_line.c */
        ...
        rb_define_method(rb_cUString, "newlines?", rb_u_string_newline, 0); /* in ext/u/rb_u_string_newline.c */
        ...
        rb_define_method(rb_cUString, "printable?", rb_u_string_print, 0); /* in ext/u/rb_u_string_print.c */
        ...
        rb_define_method(rb_cUString, "size", rb_u_string_length, 0); /* in ext/u/rb_u_string_length.c */
        rb_define_method(rb_cUString, "slice", rb_u_string_aref_m, -1); /* in ext/u/rb_u_string_aref.c */
        ...
        rb_define_method(rb_cUString, "start_with?", rb_u_string_starts_with, -1); /* in ext/u/rb_u_string_starts_with.c */
        rb_define_method(rb_cUString, "starts_with?", rb_u_string_starts_with, -1); /* in ext/u/rb_u_string_starts_with.c */
        ...
        rb_define_method(rb_cUString, "to_s", rb_u_string_to_str, 0); /* in ext/u/rb_u_string_to_str.c */
        ...
        rb_define_method(rb_cUString, "xdigits?", rb_u_string_xdigit, 0); /* in ext/u/rb_u_string_xdigit.c */
