...
Init_u_string(VALUE mU)
{
        ...
        rb_define_method(rb_cUString, "cntrl?", rb_u_string_cntrl, 0);
        rb_define_method(rb_cUString, "codepoints", rb_u_string_each_codepoint, 0);
        rb_define_method(rb_cUString, "combining_class", rb_u_string_combining_class, 0);
        rb_define_method(rb_cUString, "collate_key", rb_u_string_collate_key, 0);
        rb_define_method(rb_cUString, "count", rb_u_string_count, -1);
        rb_define_method(rb_cUString, "defined?", rb_u_string_defined, 0);
        rb_define_method(rb_cUString, "delete", rb_u_string_delete, -1);
        rb_define_method(rb_cUString, "digit?", rb_u_string_digit, 0);
        rb_define_method(rb_cUString, "digits?", rb_u_string_digit, 0);
        ...
        rb_define_method(rb_cUString, "punct?", rb_u_string_punct, 0);
        ...
        rb_define_method(rb_cUString, "space?", rb_u_string_space, 0);
        ...
        rb_define_method(rb_cUString, "type", rb_u_string_type, 0);
        rb_define_method(rb_cUString, "upcase", rb_u_string_upcase, -1);
        rb_define_method(rb_cUString, "upper?", rb_u_string_upper, -1);
        rb_define_method(rb_cUString, "valid_encoding?", rb_u_string_valid_encoding, 0);
        rb_define_method(rb_cUString, "wide?", rb_u_string_wide, 0);
        rb_define_method(rb_cUString, "wide_cjk?", rb_u_string_wide_cjk, 0);
